			...
			<div class="logoBar">
				<div class="comWidth">
					...
					<div class="shopCar fr">
						<a href="#" class="shopText fl">购物车</a> <a href="#"
							class="shopNum fl">0</a>
					</div>
				</div>
			</div>
			<!--标题头部-->
			<div class="navBox">
				...
				<ul class="nav fl">
					<c:forEach items="${sessionScope.categories }" var="category">
						<li><a
							href="${pageContext.request.contextPath}/product_list?cid=${category.cid}">${category.cname}</a></li>
					</c:forEach>
				</ul>
			</div>
		</div>
		...
		<div class="rightArea">
			...
			<div class="addInfo clearfix">
				...
				<div class="fr screen_text">
					...
					</span> <span class="shop_number"> 共<em>16422</em>件
					</span>
				</div>
			</div>
	...
	<div class="page">
		...
		<c:forEach begin="1" end="${ pageBean.totalPage}" step="1"
			...
			<c:if test="${stat.index== pageBean.currentPage}">
				<a href="javascript:void(0);" class="active">${ stat.index}</a>
			</c:if>
			<c:if test="${stat.index!= pageBean.currentPage}">
