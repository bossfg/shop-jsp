...
<script type="text/javascript">
	function confirmOrder(){
		...
		window.location="${pageContext.request.contextPath}/confiromOrder?address="+address+"&name="+name+"&telephone="+telephone;
	}
</script>
</head>
	...
	<div class="container">
		<div class="row">
					...
					<tbody>
						...
						<c:forEach items="${sessionScope.car.carItems}" var="item">
							<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" value="${item.value.buyNum}" maxlength="4" size="10">
								</td>
								<td width="15%">
			...
			<div style="text-align: right; margin-right: 120px;">
				商品金额: <strong style="color: #ff6600;">￥${sessionScope.car.total}元</strong>
			</div>
